...
namespace PlayerID3
{
    ...
    struct ID3Frame
    {
        ...
        char* value;
        ID3Frame* next;
        ID3Frame(const char* key, const char* value);
        void Print();
        ~ID3Frame();
    };
    ...
    class ID3FrameList
    {
        ...
        public:
            ...
            void AddFrame(const char* key, const char* value);
            bool DoesFrameExist(const char* key);
            char* GetFrameValue(const char* key);
            void Print();
            ~ID3FrameList();
    };
